//[Android](../../../index.md)/[br.com.arch.toolkit.android.statemachine](../index.md)/[SceneStateMachine](index.md)

# SceneStateMachine

[android]\
class [SceneStateMachine](index.md) : [StateMachine](../-state-machine/index.md)&lt;[SceneStateMachine.State](-state/index.md)&gt; 

Implementation of [StateMachine](../-state-machine/index.md) This implementation uses the Scene framework to make State transitions

## Constructors

| | |
|---|---|
| [SceneStateMachine](-scene-state-machine.md) | [android]<br>constructor() |

## Types

| Name | Summary |
|---|---|
| [State](-state/index.md) | [android]<br>class [State](-state/index.md) : [StateMachine.State](../-state-machine/-state/index.md)<br>Represents a single state in a [SceneStateMachine](index.md). |
...
| Name | Summary |
|---|---|
| [addState](../-state-machine/add-state.md) | [android]<br>fun [addState](../-state-machine/add-state.md)(key: [Int](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-int/index.html), state: [SceneStateMachine.State](-state/index.md)): [StateMachine](../-state-machine/index.md)&lt;[SceneStateMachine.State](-state/index.md)&gt;<br>Adds a new state to the machine. |
...
| [newStateInstance](new-state-instance.md) | [android]<br>open override fun [newStateInstance](new-state-instance.md)(): [SceneStateMachine.State](-state/index.md)<br>Creates a new instance of the specific state type. |
| [restoreInstanceState](../-state-machine/restore-instance-state.md) | [android]<br>fun [restoreInstanceState](../-state-machine/restore-instance-state.md)(savedInstanceState: ERROR CLASS: Symbol not found for Bundle??): [StateMachine](../-state-machine/index.md)&lt;[SceneStateMachine.State](-state/index.md)&gt;<br>Restores the state of the machine from a Bundle. |
...
| [setup](../-state-machine/setup.md) | [android]<br>inline fun [setup](../-state-machine/setup.md)(func: [StateMachine](../-state-machine/index.md)&lt;[SceneStateMachine.State](-state/index.md)&gt;.() -&gt; [Unit](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-unit/index.html))<br>Configures and starts the [StateMachine](../-state-machine/index.md). |
...
| [state](../-state-machine/state.md) | [android]<br>inline fun [state](../-state-machine/state.md)(key: [Int](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-int/index.html), stateConfig: [SceneStateMachine.State](-state/index.md).() -&gt; [Unit](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-unit/index.html)): [StateMachine](../-state-machine/index.md)&lt;[SceneStateMachine.State](-state/index.md)&gt;<br>Adds a new state to the [StateMachine](../-state-machine/index.md) using a DSL-like syntax. |