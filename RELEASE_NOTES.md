...
Maintenance changes based on tag `1.3.1`.
...
- Add persistence recreation, default-value and blank-value removal tests, preserving the existing coverage floors.
...
| `arch-lumber` | `1.3.1` | `1.4.0` |
| `robolectric-test` | `4.16.1` | `4.17` |
